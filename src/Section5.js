...
function Section5() {
  ...
  return (
    ...
    >
      ...
      <div className='w:11/12 mx:auto f:white t:center f:14 f:14@lg' data-aos="fade" data-aos-duration="1500">
        <div className='w:1 h:35 bg:#C79F62 mx:auto mb:15'></div>
        <div className='flex flex:col flex:row@lg gap:8@lg'>
          <div className='mb:8 mb:3%@lg b:1@lg b:#C79F62 py:25@lg px:15@lg '>
            <div className='f:#C79F62 f:bold f:15@lg mb:5@lg'>櫻花SAVGO廚具</div>
            <div>簡約奢華歐式廚電，讓您專注烹飪的樂趣，體驗歐洲獨有風尚</div>
          </div>
          <div className='mb:8 mb:3%@lg b:1@lg b:#C79F62 py:25@lg px:15@lg'>
            <div className='f:#C79F62 f:bold f:15@lg mb:5@lg'>HCG單體馬桶</div>
            <div>兩段式省水標章，融合科技與美學的智慧結晶，賦予宅邸自在時尚</div>
          </div>
          <div className='mb:8 mb:3%@lg b:1@lg b:#C79F62 py:25@lg px:15@lg'>
            <div className='f:#C79F62 f:bold f:15@lg mb:5@lg'>優墅防盜氣密窗</div>
            <div>採雙氣密條、雙層玻璃，有效防水、隔音，阻遏外在干擾的屏障</div>
          </div>
          <div className='mb:8 mb:3%@lg b:1@lg b:#C79F62 py:25@lg px:15@lg'>
            <div className='f:#C79F62 f:bold f:15@lg mb:5@lg'>不斷電系統</div>
            <div>主電源故障時，提供緊急能量，可於家中大型電器進行穩定供給</div>
          </div>
          <div className='mb:8 mb:3%@lg b:1@lg b:#C79F62 py:25@lg px:15@lg'>
            <div className='f:#C79F62 f:bold f:15@lg mb:5@lg'>RC抗震結構</div>
      ...
      <div className='w:80% center mb:0 pt:20% w:1/2@lg pt:3%@lg' 
        data-aos="fade" data-aos-duration="1500" >
          <Slider {...settings} >
            {
              data.map((item,index)=>{
