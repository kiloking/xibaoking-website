...
function Section2() {
  ...
  return (
    <div className='min-h:100vh bg:#18517e rel'>
      <div
      ...
      <div className='flex flex:col jc:center w:60% mx:auto pt:30% rel z:1 f:white pt:10%@lg w:1/2@lg '>
        <div className='w:full center mb:20 w:20%@lg w:50%@sm' 
          data-aos="fade" data-aos-duration="1500" >
            <img src={process.env.PUBLIC_URL+'/images/section2/intro_title.png'} alt="" className='w:full'/> 
        </div>
        <div className='by:2 py:20 f:16 lh:1.5 t:justify f:1.5rem@sm' data-aos="fade" data-aos-duration="1500">
