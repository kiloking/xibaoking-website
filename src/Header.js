...
function Header() {
  return (
    <div id="header" className='h:100vh rel bg:black  ' >
      <div
        className='inset:0 abs  bg:center bg:no-repeat bg:cover bg:fixed bg:scroll@lg z:1 background-position:center@lg'
        style={{backgroundImage: `url(${process.env.PUBLIC_URL +'/images/header_bg.png'})`}}
        data-aos="fade" data-aos-duration="1500"
      ></div>
      <div className='flex flex:col jc:center w:80% mx:auto pt:90 rel z:1 w:30%@lg pt:15%@lg'>
