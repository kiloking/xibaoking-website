  ...
  return (
    <div className='min-h:100vh bg:#070302 rel'>
      ...
      <div className='flex flex:col jc:center w:80% mx:auto pt:20% rel z:1  pt:5%@sm'>
        <div className='w:full center mb:15 w:30%@lg w:80%@sm' 
          data-aos="fade" data-aos-duration="1500" >
        ...
        <div className='flex flex:col flex:row@lg ai:center@lg jc:center@lg  '>
          <div className='w:full center mb:15 w:1/2@lg pt:5%@lg w:80%@sm pt:5%@sm' 
            data-aos="fade" data-aos-duration="1500" >
              <img src={process.env.PUBLIC_URL+'/images/section4/block.png'} alt="" className='w:full w:1/2@lg mx:auto@lg'/> 
          </div>
          <div className='w:full center mb:10 pt:5% w:1/2@lg pb:80@sm' 
            data-aos="fade" data-aos-duration="1500" >
            <Slider {...settings} >
              {
                data.map((item,index)=>{
